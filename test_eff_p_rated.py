...
P_test = np.linspace(0, 3000, 100000)
diff = old_eff(P_test, 500) - new_eff(P_test, 500)
max_diff = np.max(np.abs(diff))
print("Max diff with P_rated=500:", max_diff)

diff = old_eff(P_test, 2000) - new_eff(P_test, 2000)
max_diff = np.max(np.abs(diff))
print("Max diff with P_rated=2000:", max_diff)
